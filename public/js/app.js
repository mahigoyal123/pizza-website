...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format('hh:mm A, DD/MM/YYYY');
      status.appendChild(time);

      if (status.nextElementSibling) {
        status.nextElementSibling.classList.add('current'); //for next  ---> status.nextElementSibling.classList.add('current')
      }
    }
  });
}
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51HouOLBr5tPFatsjUdgVzEKXTIFP7NJ6Q3NjN3fK641o8BgppY7JeRiz9MOZHok9YtPtEd6eI8sr7PqcGnvRIwZF00fSbSd29f');
...
__webpack_require__(/*! C:\Users\MILIND\Desktop\Food order\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\MILIND\Desktop\Food order\resources\scss\app.scss */"./resources/scss/app.scss");
